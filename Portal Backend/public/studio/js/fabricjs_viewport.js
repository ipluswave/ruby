...
(function() {
  ...
  fabric.Viewport = (function() {
    ...
    Viewport.prototype._transformEventParams = function(e) {
      var offsetLeft, offsetTop, scrollTop;
      offsetTop = this.canvas.wrapperEl.getBoundingClientRect().top;
      offsetLeft = this.canvas.wrapperEl.getBoundingClientRect().left;
        
      return {
        which: 1,
        clientX: (e.clientX - offsetLeft) / this.zoom + offsetLeft - this.translate().x+$(window).scrollLeft(),
        clientY: ((e.clientY - offsetTop) / this.zoom + offsetTop - this.translate().y)+$(window).scrollTop(),
